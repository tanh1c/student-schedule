...
if (isProduction && !process.env.CREDENTIALS_ENCRYPTION_KEY) {
    console.error('❌ FATAL: CREDENTIALS_ENCRYPTION_KEY env var is required in production!');
    process.exit(1);
}
...
export default {
    ...
    security: {
        ...
        encryptionKey: process.env.CREDENTIALS_ENCRYPTION_KEY || DEV_ENCRYPTION_KEY,
    },
    urls: {
